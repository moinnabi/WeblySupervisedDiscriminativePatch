function part_bbox = inv_relpos_gt2p(gt_bbox,relpos_patch,norm_fl)
...
for ptc = 1:length(relpos_patch)
    ...
    part_bbox{ptc} = inv_relpos_gt2p_in(gt_bbox,relpos,norm_fl);
end
end

function part_bbox = inv_relpos_gt2p_in(gt_bbox,rel_position,norm_fl)
