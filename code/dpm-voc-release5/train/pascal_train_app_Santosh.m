function model = pascal_train_app(cls, n, note)
% Train a model.
...
% main modifications done by Santosh Divvala (santosh@cs.cmu.edu)
% 1. change aspect-ratio based split() function to appeareance based split_app function
% 2. comment out inds = lrsplit(models{i}, spos{i}); (no longer applicable)
% 3. comment out lrsplit2 training (no longer applicable)
% 4. change for i=1:2:2*n to for i=1:n while adding parts 
% 5. change partner = i+1; to partner = []; while adding parts 
