...
conf = cv(conf, 'features.truncation_val', 1); %added later by Moin (for Latent LDA)
conf = cv(conf, 'features.path_to_bg', 'who/data/bg_pad.mat'); %added later by Moin (for Latent LDA)
