function [labels, olapval] = context_labelssepdiff_wsup(cachedir, gtruthname, ds, train_set, train_year, cls)

% copied from context_labelssep_wsup; diff test set per ngram
...
savename = [cachedir '/../' cls '/' cls '_context_labelsWolap_' train_set '_' train_year '_' gtruthname];
try
    disp(' loading');
