function [rec,prec,ap,tp_ret,ovp_ret] = VOCevaldet_hoinds(VOCopts,id,cls,draw)
% after 5Dec12 updates, this script can be replaced with VOCevaldet_wsup.m
...
ttinds = setdiff(1:numel(gtids), hoinds);
