function pascal_test_sumpool_multi(cachedir, cls, testset, year, suffix, modelname, postag)
...
disp(['pascal_test_sumpool_multi(''' cachedir ''',''' cls ''',''' testset ''',''' year ''',''' suffix ''',''' modelname ''',''' postag ''');' ]);
