function compile_wsup(opt, verb, mex_file)
...
%mex -outdir bin -v -O CXXOPTIMFLAGS="-O3 -DNDEBUG" LDOPTIMFLAGS="-O3" CXXFLAGS="\$CXXFLAGS -Wall" LDFLAGS="\$LDFLAGS -Wall"
...
if nargin < 3
  ...
  %% added by dsk
  eval([mexcmd ' external/minConf/minFunc/vec3add_sse.c']);
  eval([mexcmd ' external/minConf/minFunc/vecdot_sse.c']);
