function montage_image = montage_list(scene_match_files, mode, background_color, montage_dimensions, montage_tiles_xy)
...
if(~exist('montage_dimensions', 'var'))  | isempty(montage_dimensions)
    montage_dimensions = [montage_tiles_y * 100, montage_tiles_x * 100, 3];
...
for i = 1:num_images
    ...
    elseif mode == 2
        current_image = color(single(im2double(scene_match_files{i})));
        % added color by DSK on 17Oct11
