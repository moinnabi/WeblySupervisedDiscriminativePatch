...
%% Note (DSK 9Mar10): I am observing a small difference in the result; 766
%% x 1024 image is resized to 299 x400 by this method while imresize does
%% it to 300x400. Update this code to get rid of this discrepancy;
