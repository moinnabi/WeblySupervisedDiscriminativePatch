...
fprintf('%7.1f\t', mean(siva_iccv11(rocvals~=0)));
fprintf('\n');
% fprintf('%7s\t', 'Khan');
% for objind = 1:numclasses  
%     if rocvals(objind) ~= 0
...
fprintf('%7.1f\t', mean(ferrari_cvpr12(rocvals~=0)));
fprintf('\n');
fprintf('%7s\t', 'Ours');
for objind = 1:numclasses    
    if rocvals(objind) ~= 0
...
fprintf('%7.1f\t', mean(rocvals(rocvals~=0)));
fprintf('\n');
fprintf('%7s\t', 'Ours_25');
for objind = 1:numclasses    
    if rocvals(objind) ~= 0
...
fprintf('%7.1f\t', mean(rocvals25(rocvals~=0)));
fprintf('\n'); 
...
fprintf('%7.1f\t', mean(pff_v5(rocvals~=0)));
fprintf('\n');
fprintf('%7s\t', 'PFF_25'); 
for objind = 1:numclasses    
    if rocvals(objind) ~= 0
...
fprintf('%7.1f\t', mean(pff_v5_25(rocvals~=0)));
fprintf('\n');
