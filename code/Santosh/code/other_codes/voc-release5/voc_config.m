...
conf.threshs.samapi = 0;    % sam api is not working
if conf.threshs.samapi == 1
    conf.threshs.pcntTrngImgsPerNgram = 50/100;
    conf.threshs.pcntValImgsPerNgram = 25/100;
    conf.threshs.pcntTstImgsPerNgram = 25/100;
elseif conf.threshs.samapi == 0     % not enuf imgs for training, dont leave imgs for testing
    conf.threshs.pcntTrngImgsPerNgram = 73/100;
    conf.threshs.pcntValImgsPerNgram = 25/100;
