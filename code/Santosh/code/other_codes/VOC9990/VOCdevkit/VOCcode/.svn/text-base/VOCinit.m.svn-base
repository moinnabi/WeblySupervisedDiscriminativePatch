...
VOCopts.resdir=[cwd '/results/' VOCopts.dataset '/'];   % change this path to a writable directory for your results
VOCopts.localdir=[cwd '/local/' VOCopts.dataset '/'];   % change this path to a writable local directory for the example code
