function I = sexy_graph_asym(A, cachedir, params)
...
fprintf(fid,['node [shape=rect style="filled" width=2.0 height=1.0' ...
    ' penwidth=10 labelloc="c" fixedsize="true" fontsize="30"' ...
