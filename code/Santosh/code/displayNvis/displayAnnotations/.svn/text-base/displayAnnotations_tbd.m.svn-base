function displayAnnotations_tbd(VOCyear)
%multimachine_warp_depfun(['displayAnnotations(''' VOCyear ''')'], 10000, resdir, 1, [], 4, 0, 0);
...
% load image set
[ids,gt]=textread([imgdir '/../ImageSets/Main/train.txt'],'%s %d');
