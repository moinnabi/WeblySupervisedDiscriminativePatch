function tmp = compute_score_per_sample_IIT(ds_img,gt_bbox_all,relpos_patch_normal_selected,im_current, model_selected)
...
for j = 1:size(ds_img,1)
    ...
    [~ , ap_score , sp_score ] = part_inference_inbox_IIT(im_current, model_selected, bbox_current); % changed aftar back to italy to _IIT
