...
voc9990_dir = '/projects/grail/santosh/Datasets/Pascal_VOC/';

matfile = load([dir_data,dir_class,'_boxes_val_9990_mix.mat'],'ds_top');
txtfile = [voc9990_dir,'VOC9990/ImageSets/Main/',dir_class,'_val.txt'];
cellfile = Script_readfrom_valtxt(txtfile);

[ w_sel ] = patch_calibration(patch_per_comp,matfile,cellfile,component,voc_dir,voc9990_dir);
