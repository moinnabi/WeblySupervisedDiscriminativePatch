...
for i = 2:length(models)
  ...
  % merge stats
  model.stats.slave_problem_time = [model.stats.slave_problem_time; m.stats.slave_problem_time];
  model.stats.data_mining_time   = [model.stats.data_mining_time  ; m.stats.data_mining_time  ];
  model.stats.pos_latent_time    = [model.stats.pos_latent_time   ; m.stats.pos_latent_time   ];
end
