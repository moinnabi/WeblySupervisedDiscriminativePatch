...
try 
  ...
  model = train_lda(model, impos, false, 7, fg_overlap, 'parts_pretrain');
...
try 
  ...
  model = train(model, impos, neg_large, false, false, 1, 20, ...
                max_num_examples, fg_overlap, num_fp, false, 'hard_neg');
  save([cachedir cls '_hard_neg'], 'model');
end
