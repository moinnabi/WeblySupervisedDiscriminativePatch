...
% Normalize so everything sums to 1, equal distribution of positive and negative
weighting(y_in==1) = weighting(y_in==1)*2/sum(weighting(y_in==1));
weighting(y_in==-1) = 50*weighting(y_in==-1)*2/sum(weighting(y_in==-1));
