...
VOCopts.localdir=['/projects/grail/moinnabi/eccv14/data/bcp_elda/'];
...
VOCopts.clsimgsetpath = '/homes/grail/moinnabi/datasets/PASCALVOC/VOC2010/VOCdevkit/VOC2010/ImageSets/Main/%s_%s.txt';
...
VOCopts.clsrespath=[VOCopts.resdir 'horse/%s_cls_' VOCopts.testset '_%s.txt'];
VOCopts.detrespath=[VOCopts.resdir 'horse/%s_det_' VOCopts.testset '_%s.txt'];
